...
- Final production artifacts, packaged smoke inspection, draft publication and public metadata/download verification are the remaining release gates. The build manifest pins their source commit and byte hashes; no source rebuild occurs during publication.
